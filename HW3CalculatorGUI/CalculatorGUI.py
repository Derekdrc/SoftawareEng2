...
class main_page(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button_1 = Button(self, text="1", padx=40, pady=20, command=lambda: button_click(1))
        button_2 = Button(self, text="2", padx=40, pady=20, command=lambda: button_click(2))
        button_3 = Button(self, text="3", padx=40, pady=20, command=lambda: button_click(3))
        button_4 = Button(self, text="4", padx=40, pady=20, command=lambda: button_click(4))
        button_5 = Button(self, text="5", padx=40, pady=20, command=lambda: button_click(5))
        button_6 = Button(self, text="6", padx=40, pady=20, command=lambda: button_click(6))
        button_7 = Button(self, text="7", padx=40, pady=20, command=lambda: button_click(7))
        button_8 = Button(self, text="8", padx=40, pady=20, command=lambda: button_click(8))
        button_9 = Button(self, text="9", padx=40, pady=20, command=lambda: button_click(9))
        button_0 = Button(self, text="0", padx=40, pady=20, command=lambda: button_click(0))
...
class currency_page(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # putting the button in its place by
        # using grid
        temperature_button.grid(row=1, column=2, padx=10, pady=10)

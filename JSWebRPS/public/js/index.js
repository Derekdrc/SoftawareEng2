...
const enemyScore = document.getElementById('other-score');
...
function setPlayerTag(playerId) {
    if (playerId === 1) {
        ...
        playerTwoTag.innerText = "Other Player (Player 2)";
    } else {
        playerOneTag.innerText = "Other Player (Player 1)";
...
function choose(choice) {
    if (choice === "rock") {
        ...
        rock.classList.add("choseImg");
    } else if (choice === "paper") {
        paper.classList.add("my-choice");
        paper.classList.add("choseImg");
    } else {
        scissor.classList.add("my-choice");
        scissor.classList.add("choseImg");
    }
...
function removeChoice(choice) {
    if (choice === "rock") {
        ...
        rock.classList.remove("choseImg");
    } else if (choice === "paper") {
        paper.classList.remove("my-choice");
        paper.classList.remove("choseImg");
    } else {
        scissor.classList.remove("my-choice");
        scissor.classList.remove("choseImg");
    }
